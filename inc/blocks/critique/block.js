( function( editor, components, i18n, element ) {
	...
	registerBlockType( 'ev/critique-block', { // The name of our block. Must be a string with prefix. Example: my-plugin/my-custom-block.
		title: i18n.__( 'Critique' ), // The title of our block.
		description: i18n.__( 'Un bloc pour afficher un critique.' ), // The description of our block.
		icon: 'star-half', // format-quote // Dashicon icon for our block. Custom icons can be added using inline SVGs.
